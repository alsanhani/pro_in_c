...
void add(){
	...
	char a;
	do{
		AnasMarket.open("SuperMarket.txt", ios::app);
		cout << "\n\n\t--------------------------------------------------------------";
...
void display(){
	...
	switch(ch){
		...
		case '2':
		{
			...
			AnasMarket.open("SuperMarket.txt");
			cout << AnasMarket.rdbuf();
			AnasMarket.close();
